...
<p style="text-align: center;">
	<img src = './images/sample5.png' alt='Скриншот игры' width="500" style="max-width: 70%;">
</p>  
<p style="text-align: center;">
...
### Планы по доработке
В будущем планируется придумать и создать возможность наложения дополнительных препятствий для змейки, а также режим для 2 игроков.


## Техническая документация 

### borders/
Папка содержит заготовки для перегородок. Каждый txt файл содержит строки с координатами перегородок через пробел. 
...
3. `our_snake(snake_block, snake_list, snake_color=[0,0,0])`, отрисовывает змейку на каждом шаге.
	* snake_block, int  - размер звена змейки, обязательный;
